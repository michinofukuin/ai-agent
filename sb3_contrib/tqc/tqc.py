...
from stable_baselines3.sac.policies import Actor, CnnPolicy, MlpPolicy, MultiInputPolicy, SACPolicy,ICM
...
class TQC(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            new_re=0
            if self.inum==0:
                new_re=self.icm.compute_irs(replay_data, gradient_step)
            with th.no_grad():
                ...
                target_quantiles = replay_data.rewards + new_re + (1 - replay_data.dones) * self.gamma * target_quantiles
